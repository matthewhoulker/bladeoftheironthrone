...
export class botitActorSheet extends ActorSheet {
  ...
  static get defaultOptions() {
    return mergeObject(super.defaultOptions, {
      classes: ["bladeoftheironthrone", "sheet", "actor"],
      template: "systems/bladeoftheironthrone/templates/actor/actor-sheet.html",
      width: 600,
      height: 600,
  ...
  /** @override */
  get template() {
    return `systems/bladeoftheironthrone/templates/actor/actor-${this.actor.data.type}-sheet.html`;
  }
  ...
  _prepareCharacterData(context) {
    ...
    for (let [k, v] of Object.entries(context.data.passionAttributes)) {
      v.label = game.i18n.localize(CONFIG.BLADEOFTHEIRONTHRONE.derivedAbilities[k]) ?? k;
    }
  }
